...
function Hero() {
  ...
  return (
    <>
      <div style={heroStyle} className="mt-1 mt-6 text-center bg-[#8ecae6] p-1 p-6 shadow-md mb-4">
        ...
        <div className="block space-y-4 mt-4 sm:space-x-3">
          <Link to="/create" className="bg-[#fb8500] hover:bg-[#ffb703] text-black font-bold py-3 px-6 text-lg rounded-full inline-block">
            Create Post
          </Link>
          <Link to="/posts" className="bg-[#fb8500] hover:bg-[#ffb703] text-black font-bold py-3 px-6 text-lg rounded-full inline-block">
            View Posts
          </Link>
        </div>
      </div>
